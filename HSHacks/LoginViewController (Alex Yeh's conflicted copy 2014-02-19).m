...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    [UIView animateWithDuration: 1.0f
                     ...
                     completion:^(BOOL finished){
                         ...
                         CGRect tbuttonF = CGRectMake(twitterButton.frame.origin.x,logo.frame.origin.y+120,twitterButton.frame.size.width,twitterButton.frame.size.height);
                         CGRect fButtonF = CGRectMake(facebookButton.frame.origin.x,logo.frame.origin.y+180,facebookButton.frame.size.width,facebookButton.frame.size.height);
                         CGRect gButtonF = CGRectMake(guestButton.frame.origin.x,logo.frame.origin.y+240,guestButton.frame.size.width,guestButton.frame.size.height);
